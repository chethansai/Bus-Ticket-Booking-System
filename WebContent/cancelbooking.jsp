...
Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","root","");
       ...
       //request.setAttribute("bus",rs.getString(1));
       //System.out.println("hi");
       
%>
<form method="post" action="/BTMS1/seatdrop.jsp">
<center><br><br><br>
  ...
  <input type="submit" style="width: 100px; height: 30px; font-size: 20px;" value="Submit" onclick="window.location.href=/BTMS1/seatdrop.jsp" >
</center></form>
